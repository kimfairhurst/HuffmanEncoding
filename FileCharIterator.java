 ...
 * format. Note: you might not be able to delete files read by this iterator
 * unless you call closeStream() after using FileCharIterator.
 * 
 */
public class FileCharIterator implements Iterator<String> {
    ...
    /**
     * Use this method to close the FileInputStream once you're done using
     * FileCharIterator.
     */
